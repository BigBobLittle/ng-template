...
export class DashboardComponent implements OnInit {
  ...
  statistics: { totalUsers: string; totalPatients: string; totalDoctors: string; totalAdmins: string; };
  ...
  constructor( private adminService:AdminService, private coreService:CoreService ) { //private pageTitleService: PageTitleService
  ...
  ngOnInit() {
   ...
   //data table with all users information
...
displayedColumns: string[] = [ 'phonenumber', 'email', 'role', 'createdAt', 'action'];
 // dataSource =  this.PeriodicElement;
  ...
  /**************default*************************************************************************************************************** */
  /** 
    * addNewUserDialog method is used to open a add new user dialog. //default
    */   
  addNewUserDialog() {
